...
export default function Home() {
  ...
  const description =
    "Karpuz is a network of communities based on people's interests. Find communities you're interested in, and become part of an online community!";

  const title = 'karpuz: the front page of the internet';
